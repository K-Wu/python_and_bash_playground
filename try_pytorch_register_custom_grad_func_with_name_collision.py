...
def make_fake_LegendrePolynomial3():
    class LegendrePolynomial3(torch.autograd.Function):
        ...
        def backward(ctx, grad_output):
            ...
            return grad_output * 1.5 * (5 * inputs**2)

    return LegendrePolynomial3


def make_LegendrePolynomial3():
    class LegendrePolynomial3(torch.autograd.Function):
        """
        We can implement our own custom autograd Functions by subclassing
        torch.autograd.Function and implementing the forward and backward passes
...
LegendrePolynomial3 = make_LegendrePolynomial3()
LegendrePolynomial3_fake = make_fake_LegendrePolynomial3()
