...
class LegendrePolynomial3(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, inputs, save_ref):
        """
        ...
        print("Fwd", id(ctx), type(ctx), my_ref())
    ...
    def backward(ctx, grad_output):
        ...
        print(
            ...
            id(ctx),
            type(ctx),
            isinstance(ctx, torch.autograd.function.FunctionCtx),
            my_ref(),
        )
